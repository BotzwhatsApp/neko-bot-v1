...
exports.createExif = (pack, auth) =>{
    ...
    fs.writeFileSync('./database/media/sticker/data.exif', Buffer.concat([_, __, ___, ____]), function (err) {
...
exports.modStick = (media, nino, mek, from) => {
    ...
    try {
        ...
        spawn('webpmux', ['-set','exif', './database/media/sticker/data.exif', media, '-o', out])
